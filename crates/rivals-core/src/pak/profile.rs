...
pub const MARVEL_AES_KEY_HEX: &str =
...
pub const NAMED_AES_KEYS: &[([u8; 16], &str)] = &[(
    [
...
impl PackCompression {
    pub fn repak(self) -> [repak::Compression; 1] {
        match self {
    ...
    pub fn retoc(self) -> retoc::compression::CompressionMethod {
        match self {
...
pub const RIVALS_BLOCK_SIZE: u32 = 0x10000;

pub const RIVALS_MOUNT_POINT: &str = "../../../";
...
pub struct RivalsPakProfile;

pub const RIVALS_PROFILE: RivalsPakProfile = RivalsPakProfile;

impl RivalsPakProfile {
    pub fn pak_version(self) -> repak::Version {
        repak::Version::V11
    }

    pub fn compression(self) -> [repak::Compression; 1] {
    ...
    pub fn make_aes_key(self) -> Result<aes::Aes256, String> {
    ...
    pub fn repak_key_chain(self) -> Result<repak::KeyChain, String> {
    ...
    pub fn repak_profile(self) -> repak::PakProfile {
        repak::PakProfile {
    ...
    pub fn strip_mount_prefix(self, path: &str) -> String {
...
pub fn strip_mount_prefix(path: &str) -> String {
...
pub fn guid_from_bytes(bytes: &[u8; 16]) -> Result<retoc::FGuid, String> {
...
pub fn obfuscation_key() -> Result<retoc::AesKey, String> {
...
/// consistently.
pub fn make_config() -> Result<Arc<retoc::Config>, String> {
